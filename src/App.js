        ...
        <Router>
          <div>
            ...
            <Switch>
              ...
              <PrivateRoute path="/contact/:id/edit" component={ContactEditPage} />
              <PrivateRoute exact path="/contact/:id" component={ContactDetailsPage} />
              {/* <Route exact path="/contact" component={ContactPage} /> */}
              <PrivateRoute exact path="/contact" component={ContactPage} />
              <PrivateRoute path="/" component={ContactPage} />
            </Switch>
          </div>
        </Router>
      </div >
